FILES = ./build/kernel.asm.o ./build/kernel.o ./build/terminal/terminal.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/string/string.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o
INCLUDES = -I./src
