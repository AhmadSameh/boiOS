FILES = ./build/kernel.asm.o ./build/kernel.o ./build/terminal/terminal.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/string/string.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o ./build/fs/pparser.o ./build/disk/streamer.o ./build/fs/file.o ./build/fs/fat/fat16.o ./build/gdt/gdt.o ./build/gdt/gdt.asm.o ./build/task/tss.asm.o ./build/task/task.o ./build/task/process.o ./build/task/task.asm.o ./build/isr80h/isr80h.o ./build/isr80h/misc.o ./build/isr80h/io.o ./build/isr80h/timer.o ./build/keyboard/keyboard.o ./build/keyboard/classic.o ./build/loader/formats/elf.o ./build/loader/formats/elfloader.o ./build/isr80h/heap.o ./build/isr80h/process.o ./build/timer/pit.o
INCLUDES = -I./src
...
all: ./bin/boot.bin ./bin/kernel.bin user_programs
	...
	# copy a file over
	# mkdir test_folder
	sudo cp -r ./tesf /mnt/d
	sudo cp ./hello.txt /mnt/d/tesf
	sudo cp ./programs/blank/echo /mnt/d
...
./build/isr80h/timer.o: ./src/isr80h/timer.c
	i686-elf-gcc $(INCLUDES) -I./src/isr80h $(FLAGS) -std=gnu99 -c ./src/isr80h/timer.c -o ./build/isr80h/timer.o
...
./build/fs/fat/fat16.o: ./src/fs/fat/fat16.c
	i686-elf-gcc $(INCLUDES) -I./src/fat -I./src/fs $(FLAGS) -std=gnu99 -c ./src/fs/fat/fat16.c -o ./build/fs/fat/fat16.o
...
./build/timer/pit.o: ./src/timer/pit.c
	i686-elf-gcc $(INCLUDES) -I./src/timer $(FLAGS) -std=gnu99 -c ./src/timer/pit.c -o ./build/timer/pit.o
